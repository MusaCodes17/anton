...
Ordered; "immediate" means *next few sessions*, not emergencies — nothing is on fire. **All of R2 (2.1–2.7) + R2.7.1 + R2.7.2 + RA1.0 + RA1.1 + RA1.1b + RA1.2 + RA1.3 + RA1.4 (code) + R3.1 + R3.2 + R3.3 + R3.4 + R3.6 + R4.1 + R4.2 + R4.4 + Defect Block A + Defect Block B are now shipped.** Suite: **374 passing**. RA1.5 cutover is the blocking human task; roadmap R4.2/R4.3 remain blocked on R3.5.
